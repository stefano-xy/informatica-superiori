...
- Introduzione alla programmazione con _Python_ attraverso _FARE_ e _OnlineGDB_. _(in via di pubblicazione)_
- Pagine web con _HTML_, _CSS_, _JavaScript_. _(in via di pubblicazione)_
- [Esempi](2INF/esempi/index.md) e [esercitazioni](2INF/esercitazioni/index.md) relative.
